...
void SetWorldViewProjection2D( void )
{
	...
	D3DXMatrixOrthoOffCenterLH(&worldViewProjection, 0.0f, SCREEN_WIDTH, SCREEN_HEIGHT, 0.0f, -10.0f, 10.0f);
...
DrawData::DrawData() :drawVertexIndex(-1), shaderParam(NULL),
size(vector2s(0.0f, 0.0f)), isUseEbo(true), useDefaultVertices(true),
useBatching(false), batchingType(E_BatchingType::BatchingType_None),color(1.0f,1.0f,1.0f,1.0f),tileData(NULL)
{
